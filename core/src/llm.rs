...
pub struct ChatMessage {
    /// Transcript role for this line (peer vs. this agent; often [`USER_ROLE`](crate::session::USER_ROLE) or [`ASSISTANT_ROLE`](crate::session::ASSISTANT_ROLE) when talking to provider APIs).
    pub role: String,
    pub content: String,
}
...
pub struct LlmCompletion {
    /// Text to record under [`ActiveSession::agent_role`](crate::session::ActiveSession) and show via the environment.
    pub reply: String,
